                ...
                <div class="card-body">
                    <form action="?controller=EventoController&action=modificar_evento&id=<?= $evento->getId_evento() ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-4 text-center">
                            <button type="submit" class="btn text-white">Modificar Evento</button>
                        </div>
                        <div class="mt-4 text-center">
                            <a class="btn text-white" href="?controller=EventoController&action=lista_eventos_creados">Volver a mis eventos</a>
                        </div>
                    </form>
