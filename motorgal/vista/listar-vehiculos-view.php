                            ...
                            <?php foreach ($data['vehiculos'] as $vehiculo): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="?controller=VehiculoController&action=editarVehiculo&id=<?= $vehiculo->getId_vehiculo() ?>" class="btn btn-info btn-primary btn-sm btn-outline-dark me-2" title="Editar">
